package com.training.android.undivided.AutoReply.Database;
...
import  com.training.android.undivided.AutoReply.Database.RuleDatabaseContact.RuleEntry;
import  com.training.android.undivided.AutoReply.Database.RuleDatabaseContact.SMSEntry;
...
public class RuleDatabaseSQLHelper extends SQLiteOpenHelper {
     ...
     * @param version
     */
    public RuleDatabaseSQLHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
