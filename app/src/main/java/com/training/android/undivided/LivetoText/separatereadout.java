...
public class separatereadout extends Service implements TextToSpeech.OnInitListener {
    ...
    public void onInit(int status) {
        ...
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (result == TextToSpeech.LANG_MISSING_DATA ||
                ...
                sayHello(str);
                try{
                    //Toast.makeText(getApplicationContext(), "Delay man", Toast.LENGTH_LONG).show();
